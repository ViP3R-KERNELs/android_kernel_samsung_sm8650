...
KBUILD_CFLAGS   := -Wall -Wundef -Werror=strict-prototypes -Wno-trigraphs \
		   -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -Wno-visibility \
		   -Wno-implicit-function-declaration -Wno-implicit-int -Wno-deprecated-non-prototype -Wno-fortify-source \
		   -Werror=return-type -Wno-format-security -Wno-array-bounds -Wno-shift-count-overflow -Wno-format \
